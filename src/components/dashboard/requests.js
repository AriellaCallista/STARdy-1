...
const Requests = () => {
   ...
   const navigation = useNavigation();
    ...
    const onAcceptRequest = async (item, currUserName, currUserID, currUserPhotoURL) => {
        await acceptRequest(item, currUserName, currUserID, currUserPhotoURL);
        setAccepted(item.id);
                        ...
                        return (
                            <View style={styles.tag}>
                                ...
                                <View style={{marginLeft: 50}}>
                                    ...
                                    ? <TouchableOpacity onPress={() => onAcceptRequest(item, currUserName, currUserID, currUserPhotoURL)}>
                                        <Text style={{
                                            textAlign: 'right', 
                                            fontWeight: 'bold',
                                            color: 'white',
